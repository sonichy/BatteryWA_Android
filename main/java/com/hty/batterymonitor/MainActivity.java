...
public class MainActivity extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item_id) {
			case 0:
				...
				break;
			case 1:
				new AlertDialog.Builder(this).setIcon(R.drawable.ic_launcher).setTitle("电量监控 V7.10")
			...
			case 5:
				...
				if(s.equals(""))
					s = readFile("/sys/class/power_supply/Battery/uevent");	//华为Mate7
				AlertDialog dialog = new AlertDialog.Builder(this).setIcon(R.drawable.ic_launcher).setTitle("uevent")
						.setMessage(s)
						.setPositiveButton("确定", null).show();
	...
	private String readFile(String fileName){
		...
		try {
			...
			e.printStackTrace();
			Log.e(Thread.currentThread().getStackTrace()[2] + "", "readFile(" + fileName + "): " + e.toString());

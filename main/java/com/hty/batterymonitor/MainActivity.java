	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item_id) {
			case 0:
				...
				break;
			case 1:
				new AlertDialog.Builder(this).setIcon(R.drawable.ic_launcher).setTitle("电量监控 V7.7")
			...
			case 5:
				AlertDialog dialog = new AlertDialog.Builder(this).setIcon(R.drawable.ic_launcher).setTitle("uevent")
						.setMessage(readFile("/sys/class/power_supply/battery/uevent"))
						.setPositiveButton("确定", null).show();
